...
import Pages.TC_2_1_3_Science;
import Pages.TC_3_2_3_SignIn;
import org.testng.annotations.Test;

public class TC_2_1_3_ScienceTest extends Base {
    ...
    public void Science() throws InterruptedException {
        ...
        TC_2_1_3_Science science = homepage.Science();
        science.scienceMenuClick();
        Thread.sleep(3000);
        science.scrollDown();
        Thread.sleep(3000);
        science.postClick();
